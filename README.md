...
2. **Búsqueda Automática en Google Drive**: La app utiliza una cuenta de servicio de Google Cloud para buscar en la carpeta de Drive (y sus subcarpetas) las fotos cuyos nombres coincidan con los códigos ingresados (ejemplo: `892B-D2.jpg`).
...
5. Ve a la pestaña **Variables** del servicio en Railway y agrega las variables:
   ...
   - `GOOGLE_SERVICE_ACCOUNT_JSON`: El texto completo del archivo JSON de tu cuenta de servicio de Google.
